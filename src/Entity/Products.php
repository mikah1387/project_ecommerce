...
class Products
{
    ...
    #[Assert\NotBlank(message : 'nom de produit ne peut pas etre vide')]
    #[Assert\Length( min:4,max:150,
     minMessage:'le titre doit faire au moins {{ limit }} caracteres',
     maxMessage:'le titre doit faire au plus {{ limit }} caracteres')]
    ...
    #[ORM\Column]
    #[Assert\PositiveOrZero(message:'le stock ne peut pas etre negative')]
    ...
    #[ORM\OneToMany(mappedBy: 'products', targetEntity: OrdersDetails::class,cascade:['persist'])]
